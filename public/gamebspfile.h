...
struct StaticPropLump_t
{
	...
	StaticPropLump_t& operator=(const StaticPropLumpV4_t& _rhs)
	{
		...
		m_DiffuseModulation = { 255,255,255,255 };
		m_Scale = 1.0f;
	...
	StaticPropLump_t& operator=(const StaticPropLumpV7_t& _rhs)
	{
	...
	StaticPropLump_t& operator=(const StaticPropLumpV7_TF2_t& _rhs)
	{
		(*this) = reinterpret_cast<const StaticPropLumpV6_t&>(_rhs);
		m_Flags = _rhs.m_Flags;
		m_nMinDXLevel = _rhs.m_nMinDXLevel;
	...
	StaticPropLump_t& operator=(const StaticPropLumpV8_t& _rhs)
	{
		(*this) = reinterpret_cast<const StaticPropLumpV7_t&>(_rhs);

		m_nMinDXLevel = _rhs.m_nMinGPULevel;
		m_nMaxDXLevel = _rhs.m_nMaxGPULevel;
		m_DiffuseModulation = _rhs.m_DiffuseModulation;
		return *this;
	}

	StaticPropLump_t& operator=(const StaticPropLumpV9_t& _rhs)
	{
		(*this) = reinterpret_cast<const StaticPropLumpV8_t&>(_rhs);
