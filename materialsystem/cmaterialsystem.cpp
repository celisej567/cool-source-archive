...
// Texture-related
static ConVar mat_trilinear(		"mat_trilinear", "0", 0 );
...
static ConVar mat_bumpmap(			"mat_bumpmap", "1", 0 );
static ConVar mat_phong(			"mat_phong", "1" );
static ConVar mat_parallaxmap(		"mat_parallaxmap", "1", FCVAR_HIDDEN );
static ConVar mat_reducefillrate(	"mat_reducefillrate", "0", 0 );
...
static ConVar mat_depthbias_normal( "mat_depthbias_normal", "0.0f", FCVAR_CHEAT | 0 );
...
static ConVar mat_depthbias_decal(	"mat_depthbias_decal", "-262144", FCVAR_CHEAT | 0 );						//
...
static ConVar mat_softwarelighting( "mat_softwarelighting", "0", 0 );
...
#endif
static ConVar r_waterforcereflectentities(	"r_waterforcereflectentities", "0", 0 );
